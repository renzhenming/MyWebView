package com.rzm.webview.webviewprocess.settings;
...
import com.rzm.webview.BuildConfig;

public class MWebSetting {
    private WebSettings mWebSettings;

    public static MWebSetting getInstance(){
        return new MWebSetting();
    }
...
//        }
        ...
        LogUtils.i("WebSetting", "WebView cache dir: " + appCacheDir);
